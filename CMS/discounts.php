...
?>
<title>Particular Discounts</title>
<?php  
...
include 'modals/modal_add_discounts.php';
...
$(document).on('click', '.update', function(){
  ...
  $.ajax({
   url:"req/discounts/fetch_single.php",
   method:"POST",
   ...
   $('#disc_desc').val(data.disc_desc);    
   $('#disc_status').val(data.disc_status);    
   $('#employee_id').val(data.discid);  
    $('#operation').val("Edit");
