...
<div class="col-sm-12">
  <div class="card">
    <h6 class="card-header primary-color st_head"><i class="fa fa-bars"></i>
      &nbsp;Class List&emsp;<a href="" name="age" id="add" data-toggle="modal" data-target="#add_data_Modal"><span class="add"><i class="fa fa-plus"></i>&nbsp; Add Installments </span></a></h6>
...
include 'modals/modal_add_installments.php';
...
<script type="text/javascript">  
 $(document).ready(function(){  
  ...
  "order":[],
  "ajax":{
   url:"req/installments/fetch.php",
   type:"POST"
  }
...
// ********************************************************************************************************************************************************************************
 $(document).on('submit', '#insert_form', function(event){
  event.preventDefault(); 
       $.ajax({
    url:"req/installments/insert.php",
    method:'POST',
...
$(document).on('click', '.update', function(){
  ...
  $.ajax({
   url:"req/installments/fetch_single.php",
   method:"POST",
...
Swal.fire({
  ...
  if (result.value) {
      $.ajax({
    url:"req/installments/delete.php",
    method:"POST",
    data:{user_id:user_id},
    success:function(data)
    {
